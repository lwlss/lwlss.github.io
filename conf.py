...
BLOG_AUTHOR = "Conor Lawless"  # (translatable)
BLOG_TITLE = "lwlss"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://lwlss.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://lwlss.github.io/"
BLOG_EMAIL = "cnr.lwlss@gmail.com"
BLOG_DESCRIPTION = "Posts & pages"  # (translatable)
